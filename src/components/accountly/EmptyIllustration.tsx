...
import { Users, Receipt, Wallet, NotebookPen, BarChart3, Bell } from 'lucide-react';
...
export const NotificationsEmptyIllustration = ({ size }: { size?: number }) => {
  const tint = useTint(2);
  return <EmptyIllustration icon={<Bell strokeWidth={1.75} />} bg={tint.bg} fg={tint.fg} size={size} />;
};
