            ...
            <Paper sx={{ boxShadow: theme.customShadows.z1 }}>
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  ...
                  <ListItemButton selected={i18n === 'hi'} onClick={() => handleListItemClick('hi')}>
                    <ListItemText
                      primary={
                        <Grid container>
                          <Typography color="textPrimary">Hindi</Typography>
                          <Typography variant="caption" color="textSecondary" sx={{ ml: '8px' }}></Typography>
                        </Grid>
                      }
                    />
                  </ListItemButton>
                  <ListItemButton selected={i18n === 'gu'} onClick={() => handleListItemClick('gu')}>
                    <ListItemText
                      primary={
                        <Grid container>
