...
import { ContainerOutlined, LockOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const AccountProfile = () => {
  ...
  switch (pathname) {
    case '/apps/profiles/account/personal':
      selectedTab = 1;
      break;
    case '/apps/profiles/account/my-business':
      selectedTab = 2;
      break;
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider', width: '100%' }}>
        <Tabs value={value} onChange={handleChange} variant="scrollable" scrollButtons="auto" aria-label="account profile tab">
          ...
          <Tab
            label="My Business"
            component={Link}
            to="/apps/profiles/account/my-business"
